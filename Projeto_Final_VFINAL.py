#Grupo - Ycaro Batalha, Nadja Machado e Bruno Truber
# A idéia principal para atualizar o jogo foi incluir um evento aleatório para aconter depois da rotina da manhã e incluir uma rotina a noite
# Começamos o processo de criação com um brainstorm, onde reunimos todas nossas idéias, ditas anteriormente, e decidimos como implementar as mudanças. Primeiro incluímos uma classe chamada evento e duas suclasses evento de azar e evento de sorte, para que o evento aleatório ocorra.
